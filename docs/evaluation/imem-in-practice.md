...
All the functions in the linked list implementation using imem, get `WC^` and `MC^` type parameters to initiate the context instance, `Context[WC, MC]`, type parameters they are getting.
